 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class field_config_form extends \core_form\modal {
     ...
     */
    public function check_access_for_ajax_submission() {
        $field = $this->get_field();
        $handler = $field->get_handler();
     ...
     * @return \context
     */
    public function get_context_for_ajax_submission(): \context {
