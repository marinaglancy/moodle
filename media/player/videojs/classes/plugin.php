...
class media_videojs_plugin extends core_media_player_native {
    ...
    /** @var bool is this a youtube playlist */
    protected $youtubeplaylist = false;
    ...
    public function list_supported_urls(array $urls, array $options = array()) {
        ...
        if (count($urls) == 1 && get_config('media_videojs', 'youtube')) {
            ...
            if (preg_match($this->get_regex_youtube_playlist(), $url->out(false), $this->matches)) {
                $this->youtube = true;
                $this->youtubeplaylist = true;
                return array($url);
            }
        }
...
EOT
     ...
     * @return string PHP regular expression e.g. '~^https?://example.org/~'
     */
    protected function get_regex_youtube_playlist() {
        // Initial part of link.
