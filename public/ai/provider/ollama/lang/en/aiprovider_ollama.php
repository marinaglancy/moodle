...
$string['apikey_help'] = 'The API key used for bearer token authentication. You can get this from your Ollama account at ollama.com.';
$string['authtype'] = 'Authentication type';
$string['authtype_help'] = 'The authentication method to use when connecting to the Ollama API. Use "None" for local Ollama instances, "Basic" for username/password authentication, or "Bearer token" for cloud API services like ollama.com.';
$string['authtype_basic'] = 'Basic authentication';
$string['authtype_bearer'] = 'Bearer token';
$string['authtype_none'] = 'None';
