...
class core_coursecatlib_testcase extends advanced_testcase {
    ...
    public function test_get_children() {
        ...
        $category5 = core_course_category::create(array('name' => 'Cat5', 'idnumber' => '11', 'parent' => $category1->id, 'visible' => 0));
    ...
    public function test_course_contacts() {
        ...
        $allcourses = core_course_category::get(0)->get_courses(array('recursive' => true, 'coursecontacts' => true, 'sort' => array('idnumber' => 1)));
