...
class core_medialib_testcase extends advanced_testcase {
    ...
    public function test_get_players() {
        ...
        $manager = new core_media_manager_test();
        $this->assertSame('html5video, link', $manager->get_players_test());
    }
