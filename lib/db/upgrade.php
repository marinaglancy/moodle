    ...
    if ($oldversion < 2016102100.03) {
        ...
        if (get_config('core', 'media_plugins_sortorder') === false) {
            ...
            if ($enabledplugins['videojs']) {
                ...
                set_config('useflash', !empty($CFG->core_media_enable_flv) || !empty($CFG->core_media_enable_mp3)
                    || !empty($CFG->core_media_enable_swf), 'media_videojs');
            }
        }
        ...
        // Savepoint reached.
        upgrade_main_savepoint(true, 2016102100.03);
    }
