...
abstract class core_filetypes {
    ...
    protected static function get_default_types() {
        return array(
            ...
            'applescript' => array('type' => 'text/plain', 'icon' => 'text', 'groups' => array('sourcecode')),
            'asc' => array('type' => 'text/plain', 'icon' => 'sourcecode', 'groups' => array('sourcecode')),
            'asm' => array('type' => 'text/plain', 'icon' => 'sourcecode', 'groups' => array('sourcecode')),
            ...
            'c' => array('type' => 'text/plain', 'icon' => 'sourcecode', 'groups' => array('sourcecode')),
            'cct' => array('type' => 'shockwave/director', 'icon' => 'flash'),
            'cpp' => array('type' => 'text/plain', 'icon' => 'sourcecode', 'groups' => array('sourcecode')),
            'cs' => array('type' => 'application/x-csh', 'icon' => 'sourcecode', 'groups' => array('sourcecode')),
            ...
            'docm' => array('type' => 'application/vnd.ms-word.document.macroEnabled.12', 'icon' => 'document', 'groups' => array('document')),
            ...
            'gzip' => array('type' => 'application/g-zip', 'icon' => 'archive',
                    'groups' => array('archive'), 'string' => 'archive'),
            'h' => array('type' => 'text/plain', 'icon' => 'sourcecode', 'groups' => array('sourcecode')),
            'hpp' => array('type' => 'text/plain', 'icon' => 'sourcecode', 'groups' => array('sourcecode')),
            ...
            'java' => array('type' => 'text/plain', 'icon' => 'sourcecode', 'groups' => array('sourcecode')),
            'jar' => array('type' => 'application/java-archive', 'icon' => 'archive', 'groups' => array('archive')),
            ...
            'js' => array('type' => 'application/x-javascript', 'icon' => 'text', 'groups' => array('web_file', 'sourcecode')),
            'latex' => array('type' => 'application/x-latex', 'icon' => 'text'),
            'm' => array('type' => 'text/plain', 'icon' => 'sourcecode', 'groups' => array('sourcecode')),
            'mbz' => array('type' => 'application/vnd.moodle.backup', 'icon' => 'moodle', 'groups' => array('archive')),
            'mdb' => array('type' => 'application/x-msaccess', 'icon' => 'base'),
            'mht' => array('type' => 'message/rfc822', 'icon' => 'archive', 'groups' => array('web_file')),
            'mhtml' => array('type' => 'message/rfc822', 'icon' => 'archive', 'groups' => array('web_file')),
            ...
            'php' => array('type' => 'text/plain', 'icon' => 'sourcecode', 'groups' => array('sourcecode')),
            ...
            'ppsx' => array('type' => 'application/vnd.openxmlformats-officedocument.presentationml.slideshow',
                    'icon' => 'powerpoint', 'groups' => array('presentation')),
            'ppsm' => array('type' => 'application/vnd.ms-powerpoint.slideshow.macroEnabled.12', 'icon' => 'powerpoint', 'groups' => array('presentation')),
            ...
            'rtx' => array('type' => 'text/richtext', 'icon' => 'text', 'groups' => array('document')),
            'rv' => array('type' => 'audio/x-pn-realaudio-plugin', 'icon' => 'audio',
                    'groups' => array('video'), 'string' => 'video'),
            'sh' => array('type' => 'application/x-sh', 'icon' => 'sourcecode', 'groups' => array('sourcecode')),
            ...
            'tsv' => array('type' => 'text/tab-separated-values', 'icon' => 'text', 'groups' => array('spreadsheet')),
            'txt' => array('type' => 'text/plain', 'icon' => 'text', 'defaulticon' => true, 'groups' => array('document')),
            'vtt' => array('type' => 'text/vtt', 'icon' => 'text', 'groups' => array('web_file')),
            ...
            'xml' => array('type' => 'application/xml', 'icon' => 'markup', 'groups' => array('web_file')),
