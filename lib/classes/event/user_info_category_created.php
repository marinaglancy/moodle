...
class user_info_category_created extends base {
     ...
     * @return user_info_field_created
     */
    ...
    public function get_description() {
        return "The user with id '$this->userid' created the user profile field category with id '$this->objectid'.";
    }
    ...
    public static function get_objectid_mapping() {
        return array('db' => 'user_info_category', 'restore' => 'user_info_category');
    }
}
