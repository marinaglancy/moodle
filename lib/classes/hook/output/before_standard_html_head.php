...
/**
 * Allows plugins to add any head elements to the page.
 *
 * @package    core
 * @copyright  2023 Marina Glancy
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class before_standard_html_head implements described_hook, deprecated_callback_replacement {
    ...
    public static function get_hook_description(): string {
        return 'Allows plugins to add any head elements to the page.';
    }
     ...
     *
     * Legacy callback 'before_standard_html_head' is deprecated since Moodle 4.3
     */
