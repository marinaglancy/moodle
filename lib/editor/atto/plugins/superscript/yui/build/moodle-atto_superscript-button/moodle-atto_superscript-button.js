            ...
            if (cursor.ancestor('sub, sup')) {
                this.get('host').editor.once('keypress', function() {
                    ...
                    Y.soon(Y.bind(function() {
                        // Mark new sup element if one was added otherwise finish.
                        var sup = Y.one(this.get('host')
                            .getSelectionParentNode())
                            .ancestor('sup', true);
                        if (!sup) {
                            return;
                        }
                        sup.addClass('editor-superscript-new');
                        ...
                        this.get('host').setSelection(this.get('host')
                            .getSelectionFromNode(this.editor.one('.editor-superscript-new')));
                        this.editor.one('.editor-superscript-new').removeClass('editor-superscript-new');
