...
class MoodleQuickForm_duration extends MoodleQuickForm_group {
    ...
    */
    ...
    function _createElements() {
        ...
        $this->_elements[] = $this->_mform->createElement('text', 'number', get_string('time', 'form'), $attributes, true);
        unset($attributes['size']);
        $this->_elements[] = $this->_mform->createElement('select', 'timeunit', get_string('timeunit', 'form'), $this->get_units(), $attributes, true);
