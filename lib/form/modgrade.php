...
class MoodleQuickForm_modgrade extends MoodleQuickForm_group {
    ...
    public function _createElements() {
        ...
        $this->scaleformelement = $this->createElement('select', 'modgrade_scale', $langscale,
            $scales, $attributes);
        ...
        $this->maxgradeformelement = $this->createElement('text', 'modgrade_point', $langmaxgrade, array());
        ...
        $this->gradetypeformelement = $this->createElement('select', 'modgrade_type', $langtype, $gradetype,
            $attributes, true);
        ...
        if ($this->isupdate && $this->hasgrades) {
            ...
            if ($this->canrescale) {
                ...
                $rescalegradesselect = $this->createElement('select',
        ...
        if ($this->isupdate && $this->hasgrades) {
            ...
            $this->_elements[] = $this->createElement('static', 'gradesexistmsg', '', $gradesexisthtml);
        }

        // Grade type select box.
        $label = html_writer::tag('label', $this->gradetypeformelement->getLabel(),
            array('for' => $this->gradetypeformelement->getAttribute('id')));
        $this->_elements[] = $this->createElement('static', 'gradetypelabel', '', '&nbsp;'.$label);
        $this->_elements[] = $this->gradetypeformelement;
        $this->_elements[] = $this->createElement('static', 'gradetypespacer', '', '<br />');
        ...
        if (!$this->isupdate || !$this->hasgrades || $this->currentgradetype == 'scale') {
            ...
            $this->_elements[] = $this->createElement('static', 'scalelabel', '', $label);
            $this->_elements[] = $this->scaleformelement;
            $this->_elements[] = $this->createElement('static', 'scalespacer', '', '<br />');
        }
        ...
        if ($this->isupdate && $this->hasgrades && $this->canrescale && $this->currentgradetype == 'point') {
            ...
            $this->_elements[] = $this->createElement('static', 'scalelabel', '', $label . $OUTPUT->render($labelhelp));
        ...
        if (!$this->isupdate || !$this->hasgrades || $this->currentgradetype == 'point') {
            ...
            $this->_elements[] = $this->createElement('static', 'pointlabel', '', $label);
            $this->_elements[] = $this->maxgradeformelement;
            $this->_elements[] = $this->createElement('static', 'pointspacer', '', '<br />');
        }
    }
