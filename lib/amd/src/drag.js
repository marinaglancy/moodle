...
define(['jquery', 'core/autoscroll'], function($, autoScroll) {
    ...
    var t = {
         ...
         *
         * The drag proxy will be removed when drag finishes, unless you want to keep it, which
         * you can indicate by doing dragProxy.data('statusondrop', 'notremove').
         *
         * @public
         * @param {Event} Event (should be either mousedown or touchstart)
         * @param dragProxy An element for dragging with style "position: fixed;"
