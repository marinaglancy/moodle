...
function course_scale_used($courseid, $scaleid) {
    ...
    debugging('Function course_scale_used() is deprecated. Use hook \core\hook\scale_used to find wether the scale is used anywhere.',
        DEBUG_DEVELOPER);
...
function site_scale_used($scaleid, &$courses) {
    ...
    debugging('Function site_scale_used() is deprecated. Use hook \core\hook\scale_used to find wether the scale is used anywhere.',
        DEBUG_DEVELOPER);
