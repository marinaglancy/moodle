...
if (!$page = moodle_page::retrieve_edited_page($pagehash)) {
    // This can happen if the session cache becomes corrupt or the user logged out and back in in another window
    // and changed their session. Refreshing the page will generate and store the correct page hash.
    // TODO better string.
