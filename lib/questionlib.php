...
function question_delete_question($questionid) {
    ...
    core_tag::remove_all_item_tags('question', 'core_question', $question->id);
...
function question_delete_course_category($category, $newcategory, $feedback=true) {
    ...
    if (empty($newcategory)) {
        ...
        core_tag::move_context('question', 'core_question', $context, $newcontext);
...
function question_move_questions_to_category($questionids, $newcategoryid) {
    ...
    core_tag::change_items_context('question', 'core_question', $questionids, $newcontextid);
...
function question_move_category_to_context($categoryid, $oldcontextid, $newcontextid) {
    ...
    core_tag::change_items_context('question', 'core_question',
...
function _tidy_question($question, $loadtags = false) {
    ...
    if ($loadtags && core_tag::is_enabled('question', 'core_question')) {
        $question->tags = core_tag::get_item_tags_array('question', 'core_question', $question->id);
    }
}
