...
$string['privacy:metadata:chat_messages_current'] = 'Stores current session';
$string['privacy:metadata:chat_messages_current:groupid'] = 'groupid';
$string['privacy:metadata:chat_messages_current:message'] = 'message';
$string['privacy:metadata:chat_messages_current:timestamp'] = 'timestamp';
$string['privacy:metadata:chat_messages_current:userid'] = 'userid';
$string['privacy:metadata:chat_users'] = 'Keeps track of which users are in which chat rooms';
$string['privacy:metadata:chat_users:course'] = 'course';
$string['privacy:metadata:chat_users:firstping'] = 'firstping';
$string['privacy:metadata:chat_users:groupid'] = 'groupid';
$string['privacy:metadata:chat_users:ip'] = 'ip';
$string['privacy:metadata:chat_users:lang'] = 'lang';
$string['privacy:metadata:chat_users:lastmessageping'] = 'lastmessageping';
$string['privacy:metadata:chat_users:lastping'] = 'lastping';
$string['privacy:metadata:chat_users:sid'] = 'sid';
$string['privacy:metadata:chat_users:userid'] = 'userid';
$string['privacy:metadata:chat_users:version'] = 'version';
