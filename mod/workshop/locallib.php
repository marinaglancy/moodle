    ...
    protected function aggregate_grading_grades_process(array $assessments, $timegraded = null) {
        ...
        if (grade_floats_different($finalgrade, $current)) {
            ...
            if (is_null($agid)) {
                ...
                $event = \mod_workshop\event\aggregate_grade_created::create($params);
                $event->add_record_snapshot('workshop_aggregations', $record);
                $event->trigger();
                ...
                $event = \mod_workshop\event\aggregate_grade_updated::create($params);
                $event->trigger();
            }
        }
    }
