...
class mod_workshop_internal_api_testcase extends advanced_testcase {
    ...
    public function test_normalize_file_extensions() {
        ...
        $this->assertSame(['.tgz'], workshop::normalize_file_extensions('.tgz, tgz TGZ'));
        ...
        $this->assertSame(['foo'], workshop::normalize_file_extensions('. foo')); // Unrecognized exception is not prefixed with dot.
        $this->assertSame([], workshop::normalize_file_extensions('*'));
        $this->assertSame([], workshop::normalize_file_extensions('*~'));
