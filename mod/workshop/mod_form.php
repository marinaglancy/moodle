...
class mod_workshop_mod_form extends moodleform_mod {
    ...
    public function data_preprocessing(&$data) {
        if ($this->current->instance) {
            ...
            $data['submissionfiletypes'] = workshop::clean_file_extensions($data['submissionfiletypes']);
            $data['overallfeedbackfiletypes'] = workshop::clean_file_extensions($data['overallfeedbackfiletypes']);
        } else {
