...
//-------------------------------------------------------------------------------
    ...
    function add_completion_rules() {
        ...
        $mform->addElement('defaultcustom', 'completionentries', get_string('completionentriesgroup', 'glossary'),
            ['defaultvalue' => 0, 'customvalue' => 1, 'customlabel' => get_string('completionentries', 'glossary'),
                'autodetectdefault' => true], ['size' => 3]);
        $mform->setDefault('completionentries', false);
        $mform->setType('completionentries', PARAM_INT);

        return array('completionentries');
    }
