...
$string['averagebycourse'] = 'Average by course';
$string['averageforanalysis'] = 'Average: {$a}';
$string['bold'] = 'Bold';
...
$string['cannotloadxml'] = 'Can not parse XML file. Import failed.';
...
$string['insufficient_responses_for_this_group'] = 'Must be at least 2 responses to show analysis for the group';
...
$string['label'] = 'Label';
$string['labelandname'] = '({$a->label}) {$a->name}';
...
$string['typenotfound'] = 'Type <b>$a</b> not found, question not imported.';
