...
Feature: Exporting and importing feedbacks
  ...
  Scenario: Export sample feedback and compare with the fixture
    ...
    And following "Export questions" should export feedback identical to "mod/feedback/tests/fixtures/testexport.xml"
    And I log out
  ...
  Scenario: Import feedback deleting old items
    ...
    And I press "Yes"
    And I follow "Edit questions"
    And I should not see "Existing question"
  ...
  Scenario: Import feedback appending new items
    ...
    And I press "Yes"
    And I follow "Edit questions"
    And I should see "Existing question"
