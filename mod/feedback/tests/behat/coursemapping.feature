...
Feature: Mapping courses in a feedback
  ...
  Scenario: Site feedback is not mapped to any course
    ...
    And I should see "Average: 2" in the analysis for feedback question "multichoicerated"
    And I should see "2.5" in the "Course 1" "table_row"
    And I should see "1" in the "Acceptance test site" "table_row"
  ...
  Scenario: Site feedback is mapped to courses
    ...
    And I should see "3" in the "Course 3" "table_row"
    And I should see "2.5" in the "Course 2" "table_row"
