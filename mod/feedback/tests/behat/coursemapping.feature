...
Feature: Anonymous feedback
  ...
  Scenario: Site feedback is not mapped to any course
    ...
    And I should see "Acceptance test site" in the ".feedback_items" "css_element"
    ...
    And I follow "Answer the questions..."
    And I should not see "Acceptance test site" in the ".feedback_items" "css_element"
    And I should see "C1" in the ".feedback_items" "css_element"
    And I set the following fields to these values:
      | option b                         | 1        |
    ...
    And I should see "1 (33.33 %)" in the "option a (0)" "table_row"
    And I should see "1 (33.33 %)" in the "option b (1)" "table_row"
    And I should see "1 (33.33 %)" in the "option c (5)" "table_row"
    ...
    And I should see "0" in the "option a (0)" "table_row"
    And I should see "1 (50.00 %)" in the "option b (1)" "table_row"
    And I should see "1 (50.00 %)" in the "option c (5)" "table_row"
    And I log out
  ...
  Scenario: Site feedback is mapped to courses
    ...
    And I follow "Answer the questions..."
    And I should not see "Acceptance test site" in the ".feedback_items" "css_element"
    And I should see "C2" in the ".feedback_items" "css_element"
    And I set the following fields to these values:
      | option b                         | 1        |
      | this is a simple multiple choice | option e |
    And I press "Submit your answers"
    ...
    And I follow "Answer the questions..."
    And I should not see "Acceptance test site" in the ".feedback_items" "css_element"
    And I should see "C3" in the ".feedback_items" "css_element"
    And I set the following fields to these values:
      | option c                         | 1        |
      | this is a simple multiple choice | option d |
    And I press "Submit your answers"
    ...
    And I should see "0" in the "option a (0)" "table_row"
    And I should see "1 (33.33 %)" in the "option b (1)" "table_row"
    And I should see "2 (66.67 %)" in the "option c (5)" "table_row"
    ...
    And I should see "0" in the "option a (0)" "table_row"
    And I should see "0" in the "option b (1)" "table_row"
    And I should see "1 (100.00 %)" in the "option c (5)" "table_row"
