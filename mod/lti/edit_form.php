...
class mod_lti_edit_types_form extends moodleform{
    public function definition() {
        ...
        if (!empty($this->_customdata->isadmin)) {
            ...
            $mform->addElement('select', 'lti_coursevisible',
                get_string($istool ? 'show_in_course2' : 'show_in_course', 'lti'), $options);
            $mform->addHelpButton('lti_coursevisible', $istool ? 'show_in_course2' : 'show_in_course', 'lti');
