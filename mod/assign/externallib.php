    ...
    public static function save_grade_parameters() {
        ...
        return new external_function_parameters(
            array(
                ...
                'plugindata' => new external_single_structure($pluginfeedbackparams, VALUE_DEFAULT, array()),
                'advancedgradingdata' => new external_single_structure($advancedgradingdata, VALUE_DEFAULT, array())
            )
        );
    }
