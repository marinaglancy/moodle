...
class lesson_ended extends \core\event\base {
    ...
    public function get_description() {
        return 'The lesson ' . $this->other['lessonid'] . ' was ended by the user ' . $this->userid;
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'lesson', 'end', 'view.php?id=' . $this->other['cmid'], $this->objectid,
            $this->other['cmid']);
    }
}
