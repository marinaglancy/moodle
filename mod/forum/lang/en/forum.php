...
$string['privacy:metadata:forum_queue'] = 'For keeping track of posts that will be mailed in digest form';
$string['privacy:metadata:forum_queue:discussionid'] = 'discussionid';
$string['privacy:metadata:forum_queue:postid'] = 'postid';
$string['privacy:metadata:forum_queue:timemodified'] = 'The modified time of the original post';
$string['privacy:metadata:forum_queue:userid'] = 'userid';
