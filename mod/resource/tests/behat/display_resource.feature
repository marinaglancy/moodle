...
Feature: Teacher can specify different display options for the resource
  ...
  Scenario Outline: Specifying different display options for a file resource
    ...
    And I <seedate> see "Uploaded on" in the ".resourcedetails" "css_element"
    And I follow "Course 1"
    ...
    And I <seedate> see "Uploaded on" in the ".activity.resource .resourcelinkdetails" "css_element"
    And I log out
