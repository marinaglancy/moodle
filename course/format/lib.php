...
abstract class format_base {
     ...
     * @param int $courseid
     */
    public static function reset_course_cache($courseid = 0) {
        if ($courseid) {
     ...
     * @param navigation_node $node The parent node within the navigation (for course or section)
...
class format_site extends format_base {
     ...
     *
     * @param int|stdClass $section argument ignored since site does not have sections
     * @param array $options options for view URL. At the moment core uses:
     *     'navigation' (bool) if true and section has no separate page, the function returns null
     *     'sr' (int) used by multipage formats to specify to which section to return
     * @return null|moodle_url
