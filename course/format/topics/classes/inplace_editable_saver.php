...
/**
 * Contains class \format_topics\inplace_editable_saver
 *
...
class inplace_editable_saver extends \core_course\inplace_editable_saver_format {
    ...
    public function render_section_name($section, $linkifneeded = true, $editable = null) {
        ...
        $this->component = 'format_topics';
        $this->edithint = new lang_string('editsectionname', 'format_topics');
        $this->editlabel = new lang_string('newsectionname', 'format_topics', $title);
