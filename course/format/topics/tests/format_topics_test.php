...
class format_topics_testcase extends advanced_testcase {
     ...
     */
    public function test_inplace_editable_saver() {
        global $CFG, $DB, $PAGE;
        ...
        // Call format_topics\inplace_editable_saver::update_value() directly.
        $obj = new format_topics\inplace_editable_saver();
        $tmpl = $obj->update_value('sectionname', $section->id, 'Rename me again');
