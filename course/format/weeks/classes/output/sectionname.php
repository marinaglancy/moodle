...
/**
 * Contains class \format_weeks\output\sectionname
 *
...
class sectionname extends \core_course\output\sectionname {
    ...
    public function __construct($identifier, $suppresslink = false) {
        ...
        if (course_get_format($this->section->course)->get_format() !== 'weeks') {
    ...
    public function export_for_template(\renderer_base $output) {
        ...
        $this->edithint = get_string('editsectionname', 'format_weeks');
        $this->editlabel = get_string('newsectionname', 'format_weeks', $title);
