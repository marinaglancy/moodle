 ...
 */
function course_add_cm_to_section($modid, $courseid, $sectionnum, $beforemod = NULL) {
    global $DB;
...
function add_mod_to_section($mod, $beforemod=NULL) {
    ...
    return course_add_cm_to_section($mod->coursemodule, $mod->course, $mod->section, $beforemod);
}
...
/// Add the module into the new section
    course_add_cm_to_section($mod->id, $section->course, $section->section, $beforemod);
    return true;
}
