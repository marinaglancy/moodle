    ...
    if (has_capability('moodle/course:activityvisibility', $modcontext)) {
        ...
        if ($stealth) {
            ...
            $actions['hide'] = new action_menu_link_secondary(
                ...
                $str->makeunavailable,
                array('class' => 'editing_makeunavailable', 'data-action' => 'hide', 'data-sr' => $sr)
            );
            ...
            $actions[$action] = new action_menu_link_secondary(
                ...
                $str->makeavailable,
                array('class' => 'editing_makeavailable', 'data-action' => $action, 'data-sr' => $sr)
            );
        }
    }
...
function include_course_ajax($course, $usedmodules = array(), $enabledmodules = null, $config = null) {
    ...
    $PAGE->requires->js_call_amd('core/course', 'initCoursePage', array($course->format));
