...
class core_course_renderer extends plugin_renderer_base {
     ...
     * @return string
     */
    protected function frontpage_my_courses() {
        global $USER, $CFG, $DB;
     ...
     * @return string
     */
    protected function frontpage_available_courses() {
        global $CFG;
        require_once($CFG->libdir. '/coursecatlib.php');
     ...
     * @return string
     */
    protected function frontpage_combo_list() {
        global $CFG;
        require_once($CFG->libdir. '/coursecatlib.php');
        $chelper = new coursecat_helper();
     ...
     * @return string
     */
    protected function frontpage_categories_list() {
        global $CFG;
        require_once($CFG->libdir. '/coursecatlib.php');
        $chelper = new coursecat_helper();
        $chelper->set_subcat_depth($CFG->maxcategorydepth)->
