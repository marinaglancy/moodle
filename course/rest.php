...
if (in_array($class, array('resource'))) {
    list($modcontext, $course, $cminfo) = $PAGE->login_to_cm(null, $id, $courseid, PAGELOGIN_NO_AUTOLOGIN);
    $cm = $cminfo->get_course_module_record(true);
    $coursecontext = context_course::instance($course->id);
} else {
    list($coursecontext, $course) = $PAGE->login($courseid, PAGELOGIN_NO_AUTOLOGIN);
}
require_sesskey();
