...
class behat_blocks extends behat_base {
     ...
     * @param string $region
     */
    public function i_add_the_block_to_the_region($blockname, string $region) {
        if (!$this->running_javascript()) {
     ...
     */
    public function i_add_the_block_to_the_region_with($blockname, string $region, TableNode $data) {
