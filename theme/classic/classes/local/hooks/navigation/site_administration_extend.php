...
namespace theme_classic\local\hooks\navigation;
...
/**
 * Hook callbacks for theme_classic
 *
 * @package    theme_classic
 * @copyright  2023 Marina Glancy
 * @author     2018 Bas Brands
...
class site_administration_extend {
    ...
    public static function callback(\core\hook\navigation\site_administration_extend $hook): void {
        ...
        $hook->set_custom_settingpage_for_plugin(explode('\\', static::class)[0], $settings);

        if ($ADMIN->fulltree && $hook->has_site_config()) {
