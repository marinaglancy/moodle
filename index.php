...
/// If the hub plugin is installed then we let it take over the homepage here
    ...
    if (!empty($CFG->customfrontpageinclude)) {
        // Output custom front page. The following variables were present in index.php in Moodle 2.4 and they are left here for backward compartibility.
    ...
    // Output contents for frontpage as configured in $CFG->frontpage or $CFG->frontpageloggedin
