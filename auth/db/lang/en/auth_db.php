...
$string['auth_dbupdateallusers'] = 'Update all users';
$string['auth_dbupdateallusersfalse'] = 'Do not update users via scheduled task';
$string['auth_dbupdatedescription'] = 'The scheduled task can update all fields for all accounts, this can be resource intensive on some servers so you may wish to keep this disabled.';
