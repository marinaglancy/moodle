...
if (!empty($CFG->sitepolicyhandler)) {
    ...
    if ($sitepolicyurl = \core_privacy\sitepolicy\manager::get_redirect_url()) {
...
$sitepolicy = \core_privacy\sitepolicy\manager::get_embed_url(isguestuser());
if (empty($sitepolicy)) {
...
if ($agree and confirm_sesskey()) {    // User has agreed.
    \core_privacy\sitepolicy\manager::accept();
