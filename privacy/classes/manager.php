...
class manager {
    ...
    public function get_metadata_for_components() : array {
        ...
        foreach ($this->get_component_list() as $component) {
            if ($this->component_implements($component, metadata_provider::class)) {
                $metadata[$component] = static::component_class_callback($component, metadata_provider::class,
    ...
    protected function component_is_core_provider($component) {
        return $this->component_implements($component, core_data_provider::class);
    }
