...
$string['unzipselectencoding'] = 'Select filenames encoding';
$string['unzipselectencodingdesc'] = 'Names of listed files depends on encoding. Select encoding with wich filenames look correctly.';
