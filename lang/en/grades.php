...
$string['gradeconfigerrorbadpoint'] = 'Invalid Grade Value. This must be an integer between 0 and {$a}';
$string['gradeconfigerrorbadscale'] = 'Invalid scale selected. Please make sure you select a scale from the selections below.';
$string['gradeconfig'] = 'Grade';
$string['gradeconfig_help'] = 'Select the type of grading used for this activity. If "scale" is chosen, you can then choose the scale from the "scale" dropdown. If using "point" grading, you can then enter the maximum grade available for this activity.';
$string['gradeconfigmaxgrade'] = 'Maximum grade';
$string['gradeconfigtype'] = 'Type';
$string['gradeconfigtypenone'] = 'None';
$string['gradeconfigtypepoint'] = 'Point';
$string['gradeconfigtypescale'] = 'Scale';
