...
$string['privacy:metadata:scale'] = 'Grading scales, store ID of the user who created the scale. Not considered personal information';
$string['privacy:metadata:scale:description'] = 'Description of the scale';
$string['privacy:metadata:scale:name'] = 'Name of the scale';
$string['privacy:metadata:scale:scale'] = 'Values in the scale';
$string['privacy:metadata:scale:timemodified'] = 'Time when the scale was last modified';
$string['privacy:metadata:scale:userid'] = 'ID of the user who created the scale';
