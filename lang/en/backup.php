...
$string['rootsettingenrolments_help'] = 'Uncheck if you want to leave default enrolment methods only. If users are included but enrolment methods are not, all users will be restored as manual enrolments';
