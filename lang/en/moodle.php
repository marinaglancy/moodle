...
$string['hideoncoursepage'] = 'Hide from course page';
...
$string['stealthmodules'] = 'Hide activities from course page';
$string['stealthmodules_help'] = 'If enabled, every activity will have three visibility states - shown, hidden and also available but hidden from course page';
