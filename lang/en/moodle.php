...
$string['courseoverviewfiles_help'] = 'Limit the number of files (usually images) that course managers are allowed to attach to the course description. Such files will be shown publicly next to the course description in course listings such as those on the front page';
