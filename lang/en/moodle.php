...
$string['allowstealthmodules_help'] = 'If enabled, activities in the visible sections can be marked as hidden on course page but available in reports or by following a direct link';
