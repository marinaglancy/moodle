...
$string['cannotsignup'] = 'You are already logged in as {$a}, you need to log out before signing up as a different user. After logging out, press the "Create new account" button to proceed';
