...
$string['configfilterskipemail'] = 'Select the filters that should be completely skipped when formatting text before sending an email';
...
$string['filterskipemail'] = 'Filters to skip in emails';
