...
$string['configcoursesummaryfilesext'] = 'A comma-separated list of allowed course summary files extensions.';
$string['configcoursesummaryfileslimit'] = 'Limit the number of files course managers are allowed to add to the course. They will be accessible by anyone from outside of the course just like course name and/or summary';
