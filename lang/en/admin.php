...
$string['agedigitalconsentverification'] = 'Age of digital consent verification';
$string['agelocationverification_desc'] = 'Enables verification of age of digital consent before displaying the sign up page for self-registering users. This protects your site from digital minors signing up without a parental / guardian consent. Contact details of the administrator are provided to digital minors for further assistance.';
$string['ageofdigitalconsentmap'] = 'Age of digital consent';
$string['ageofdigitalconsentmap_desc'] = 'Allows to define the age of digital consent. This is used in the process of verifying the age of digital consent. The age of digital consent may be different in different countries.<br />Valid format:<br /> A default age of digital consent must be provided as a pair of wildcard character(*) and age. The exceptions of the default value must be provided as pairs of valid country code (ISO 3166-2) and valid age. Values must be separated with a space. Pairs must be separated with a new line. <br />If there is no explicit value provided for the user\'s country code, the default age of digital consent (wildcard character\'s) value is used.';
...
$string['invalidagedigitalconsent'] = 'The format of the entered age of digital consent is not valid.';
