...
class core_admin_renderer extends plugin_renderer_base {
    ...
    protected function registration_warning($registered) {
        ...
        if (!$registered) {
            ...
            if (has_capability('moodle/site:config', context_system::instance())) {
                $registerbutton = $this->single_button(new moodle_url('/admin/registration/index.php'), get_string('register', 'admin'));
    ...
    public function warn_if_not_registered() {
        ...
        return $this->registration_warning($registrationmanager->get_registeredhub() ? true : false);
    }
