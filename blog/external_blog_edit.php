...
if (!empty($id) && !$DB->record_exists('blog_external', array('id' => $id))) {
    ...
    $external->autotags = core_tag::get_item_tags_array('blog_external', 'core', $id);
}
...
if ($externalblogform->is_cancelled()) {
    ...
    switch ($action) {
        case 'add':
            ...
            core_tag::set_item_tags('blog_external', 'core', $newexternal->id,
        ...
        case 'edit':
            if ($data->id && $DB->record_exists('blog_external', array('id' => $data->id))) {
                ...
                core_tag::set_item_tags('blog_external', 'core', $external->id,
